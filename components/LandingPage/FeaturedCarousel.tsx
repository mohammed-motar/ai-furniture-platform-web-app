  ...
  return (
    <div className='relative w-full bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950'>
      ...
      >
        ...
        <CarouselPrevious className='left-4 border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-700 hover:text-white sm:left-8 cursor-pointer' />
        <CarouselNext className='right-4 border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-700 hover:text-white sm:right-8 cursor-pointer' />
      </Carousel>
